...
## Harmonising & aggregating KPI monitoring
## within Life Sciences and beyond

---
src: ../../pages/introduction/attention.md#1
...
<table class="no-row-border">
    ...
    <v-clicks>
        ...
        <tr>
            <td class="align-top pr-4">
                <mdi:tune-variant class="text-3xl text-[var(--slidev-accent)]" />
            </td>
            <td>
                <span class="font-bold">Flexible Selection:</span>
                Service providers select a pre-defined KPI set.
            </td>
        </tr>
        <tr>
            <td class="align-top pr-4">
                <mdi:sparkles class="text-3xl text-[var(--slidev-accent)]" />
            </td>
            <td>
                <span class="font-bold">Tailored Monitoring:</span>
                Service providers can add KPIs from other categories.
            </td>
        </tr>
    </v-clicks>
    </tbody>
